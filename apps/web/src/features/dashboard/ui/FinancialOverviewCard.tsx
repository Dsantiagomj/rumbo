...
export function FinancialOverviewCard({ products, activeCurrency }: FinancialOverviewCardProps) {
                ...
                return (
                  <div key={slice.key} className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex items-center gap-2 tabular-nums">
                      ...
                      <span
                        className={`font-medium ${slice.balance < 0 ? 'text-destructive' : ''}`}
                      >
